...
* neuvádí se první údaj (zdroj je katalogizována poprvé, předpoklkádá se, že nedojde ke změnám nakladatele, distributora)
...
264 21 $3 rok od do
       $a místo vydání předchozího vydavatele :
			 $předchozí vydavatel (vydával dílo mezi prvním a současným vydavatelem)
264 31 $3 rok-
       $a místo vydání současného vydavatele :
			 $b současný vydavatel
např.
...
```
např.:
datum zahájení je uvedeno ve zdroji, datum ukončení je odhadované (např. podle Waybacku, podle data zjištění nedostupnosti stránek)
264 #1 $a Praha :
    $b Petr Jandík,
	  $c 2006-[2008?]
...
datum zahájení vydávání ani datum ukončení není uvedeno ve zdroji ani nejsou data známa; data jsou zjištěna explicitně (např. dotazem na vydavatele)
264 #1 $a Praha :
    $b Petr Jandík,
		$c [2006-2008]
