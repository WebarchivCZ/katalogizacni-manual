...
Preferovaným pramenem popisu u elektronických zdrojů je především textový obsah zdoje, případně vložená metadata v textové podobě (například zdrojový kód). Informace se přebírají z formálně uvedených údajů (např.  
