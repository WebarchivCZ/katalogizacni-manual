...
pole 100 a současně s ním se nesmí v jednom záznamu vyskytovat ani pole 110 a 111. Je-li tvůrců více, do pole 100 se zapíše
pouze první z nich.
...
Pro volbu správné podoby jména (pravopis, iniciály, rozepsané iniciály apod.) se používá přednostně [Soubor národních autorit](http://aleph.nkp.cz/) dostupný na stránkách Národní knihovny ČR.
